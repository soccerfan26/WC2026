...
const WC_DATA = {
  ...
  matches: [
    ...
    {m:25, g:"A", date:"2026-06-18", home:"Czechia", away:"South Africa", venue:"Atlanta (Mercedes-Benz Stadium)", time:"12:00", utc:"2026-06-18T16:00Z", hs:1, as:1,
     scorers:[{player:"Michal Sadílek", team:"Czechia", min:6},{player:"Teboho Mokoena (P)", team:"South Africa", min:83}]},
    ...
    {m:33, g:"F", date:"2026-06-20", home:"Netherlands", away:"Sweden", venue:"Houston (NRG Stadium)", time:"12:00", utc:"2026-06-20T17:00Z", hs:5, as:1,
    ...
    {m:42, g:"I", date:"2026-06-22", home:"France", away:"Iraq", venue:"Philadelphia (Lincoln Financial Field)", time:"17:00", utc:"2026-06-22T21:00Z", hs:3, as:0,
     scorers:[{player:"Kylian Mbappé", team:"France", min:14},{player:"Kylian Mbappé", team:"France", min:48},{player:"Ousmane Dembélé", team:"France", min:66}]},
    {m:43, g:"I", date:"2026-06-22", home:"Norway", away:"Senegal", venue:"New York/NJ (MetLife Stadium)", time:"20:00", utc:"2026-06-23T00:00Z", hs:3, as:2,
    ...
    {m:48, g:"K", date:"2026-06-23", home:"Colombia", away:"DR Congo", venue:"Guadalajara (Estadio Akron)", time:"20:00", utc:"2026-06-24T02:00Z", hs:1, as:0,
     scorers:[{player:"Daniel Muñoz", team:"Colombia", min:76}]},
    {m:49, g:"B", date:"2026-06-24", home:"Switzerland", away:"Canada", venue:"Vancouver (BC Place)", time:"12:00", utc:"2026-06-24T19:00Z", hs:2, as:1,
     scorers:[{player:"Rubén Vargas", team:"Switzerland", min:46},{player:"Johan Manzambi", team:"Switzerland", min:57},{player:"Promise David", team:"Canada", min:76}]},
    {m:50, g:"B", date:"2026-06-24", home:"Bosnia and Herzegovina", away:"Qatar", venue:"Seattle (Lumen Field)", time:"12:00", utc:"2026-06-24T19:00Z", hs:3, as:1,
     scorers:[{player:"Kerim Alajbegović", team:"Bosnia and Herzegovina", min:29},{player:"Abunada (OG)", team:"Bosnia and Herzegovina", min:34},{player:"Hassan Al-Haydos", team:"Qatar", min:42},{player:"Mahmić", team:"Bosnia and Herzegovina", min:82}]},
    {m:51, g:"C", date:"2026-06-24", home:"Scotland", away:"Brazil", venue:"Miami (Hard Rock Stadium)", time:"18:00", utc:"2026-06-24T22:00Z", hs:0, as:3,
     scorers:[{player:"Vinícius Júnior", team:"Brazil", min:7},{player:"Vinícius Júnior", team:"Brazil", min:"45+3"},{player:"Matheus Cunha", team:"Brazil", min:60}]},
    {m:52, g:"C", date:"2026-06-24", home:"Morocco", away:"Haiti", venue:"Atlanta (Mercedes-Benz Stadium)", time:"18:00", utc:"2026-06-24T22:00Z", hs:4, as:2,
     scorers:[{player:"Lenny Joseph", team:"Haiti", min:10},{player:"Achraf Hakimi", team:"Morocco", min:39},{player:"Wilson Isidor", team:"Haiti", min:43},{player:"Ismael Saibari", team:"Morocco", min:"45+1"},{player:"Soufiane Rahimi", team:"Morocco", min:78},{player:"Gessime Yassine", team:"Morocco", min:89}]},
    {m:53, g:"A", date:"2026-06-24", home:"Czechia", away:"Mexico", venue:"Mexico City (Estadio Azteca)", time:"19:00", utc:"2026-06-25T01:00Z", hs:0, as:3,
     scorers:[{player:"Mateo Chávez", team:"Mexico", min:50},{player:"Julián Quiñones", team:"Mexico", min:61},{player:"Álvaro Fidalgo", team:"Mexico", min:"90+4"}]},
    {m:54, g:"A", date:"2026-06-24", home:"South Africa", away:"South Korea", venue:"Monterrey (Estadio BBVA)", time:"19:00", utc:"2026-06-25T01:00Z", hs:1, as:0,
     scorers:[{player:"Thapelo Maseko", team:"South Africa", min:63}]},
    {m:55, g:"E", date:"2026-06-25", home:"Ecuador", away:"Germany", venue:"New York/NJ (MetLife Stadium)", time:"16:00", utc:"2026-06-25T20:00Z", hs:2, as:1,
     scorers:[{player:"Leroy Sané", team:"Germany", min:2},{player:"Nilson Angulo", team:"Ecuador", min:9},{player:"Gonzalo Plata", team:"Ecuador", min:77}]},
    {m:56, g:"E", date:"2026-06-25", home:"Curaçao", away:"Ivory Coast", venue:"Philadelphia (Lincoln Financial Field)", time:"16:00", utc:"2026-06-25T20:00Z", hs:0, as:2,
     scorers:[{player:"Nicolas Pépé", team:"Ivory Coast", min:7},{player:"Nicolas Pépé", team:"Ivory Coast", min:64}]},
    {m:57, g:"F", date:"2026-06-25", home:"Tunisia", away:"Netherlands", venue:"Kansas City (Arrowhead Stadium)", time:"18:00", utc:"2026-06-25T23:00Z", hs:1, as:3,
     scorers:[{player:"Ellyes Skhiri (OG)", team:"Netherlands", min:2},{player:"Brian Brobbey", team:"Netherlands", min:7},{player:"Hazem Mastouri", team:"Tunisia", min:54},{player:"Jan Paul van Hecke", team:"Netherlands", min:62}]},
    {m:58, g:"F", date:"2026-06-25", home:"Japan", away:"Sweden", venue:"Dallas (AT&T Stadium)", time:"18:00", utc:"2026-06-25T23:00Z", hs:1, as:1,
     scorers:[{player:"Daizen Maeda", team:"Japan", min:56},{player:"Anthony Elanga", team:"Sweden", min:62}]},
    {m:59, g:"D", date:"2026-06-25", home:"Türkiye", away:"USA", venue:"Los Angeles (SoFi Stadium)", time:"19:00", utc:"2026-06-26T02:00Z", hs:3, as:2,
    ...
    {m:67, g:"L", date:"2026-06-27", home:"Panama", away:"England", venue:"New York/NJ (MetLife Stadium)", time:"17:00", utc:"2026-06-27T21:00Z", hs:0, as:2,
     scorers:[{player:"Jude Bellingham", team:"England", min:62},{player:"Harry Kane", team:"England", min:67}]},
    {m:68, g:"L", date:"2026-06-27", home:"Croatia", away:"Ghana", venue:"Philadelphia (Lincoln Financial Field)", time:"17:00", utc:"2026-06-27T21:00Z", hs:2, as:1,
     scorers:[{player:"Petar Sučić", team:"Croatia", min:31},{player:"Derrick Luckassen", team:"Ghana", min:73},{player:"Nikola Vlašić", team:"Croatia", min:83}]},
    {m:69, g:"K", date:"2026-06-27", home:"Colombia", away:"Portugal", venue:"Miami (Hard Rock Stadium)", time:"19:30", utc:"2026-06-27T23:30Z", hs:0, as:0,
     scorers:[]},
    {m:70, g:"K", date:"2026-06-27", home:"DR Congo", away:"Uzbekistan", venue:"Atlanta (Mercedes-Benz Stadium)", time:"19:30", utc:"2026-06-27T23:30Z", hs:3, as:1,
     scorers:[{player:"Eldor Shomurodov", team:"Uzbekistan", min:10},{player:"Yoane Wissa (P)", team:"DR Congo", min:68},{player:"Fiston Mayele", team:"DR Congo", min:78},{player:"Yoane Wissa", team:"DR Congo", min:"90+2"}]},
    {m:71, g:"J", date:"2026-06-27", home:"Jordan", away:"Argentina", venue:"Dallas (AT&T Stadium)", time:"21:00", utc:"2026-06-28T02:00Z", hs:1, as:3,
     scorers:[{player:"Giovani Lo Celso", team:"Argentina", min:19},{player:"Lautaro Martínez (P)", team:"Argentina", min:31},{player:"Mousa Al-Tamari", team:"Jordan", min:55},{player:"Lionel Messi", team:"Argentina", min:80}]},
    {m:72, g:"J", date:"2026-06-27", home:"Algeria", away:"Austria", venue:"Kansas City (Arrowhead Stadium)", time:"21:00", utc:"2026-06-28T02:00Z", hs:3, as:3,
     scorers:[{player:"Marko Arnautović", team:"Austria", min:28},{player:"Rafik Belghali", team:"Algeria", min:45},{player:"Marcel Sabitzer", team:"Austria", min:55},{player:"Riyad Mahrez", team:"Algeria", min:60},{player:"Saša Kalajdžić", team:"Austria", min:"90+6"},{player:"Riyad Mahrez", team:"Algeria", min:"90+8"}]}
  ],
  ...
  knockout: [
    ...
    {m:76, round:"R32", date:"2026-06-29", home:"Brazil", away:"Japan", venue:"Houston (NRG Stadium)", time:"12:00", utc:"2026-06-29T17:00Z", hs:2, as:1, w:"Brazil",
     ...
     cards:{red:[]}},
    {m:77, round:"R32", date:"2026-06-30", home:"France", away:"Sweden", venue:"New York/NJ (MetLife Stadium)", time:"17:00", utc:"2026-06-30T21:00Z", hs:3, as:0, w:"France",
    ...
    {m:83, round:"R32", date:"2026-07-02", home:"Portugal", away:"Croatia", venue:"Toronto (BMO Field)", time:"19:00", utc:"2026-07-02T23:00Z", hs:null, as:null, w:null},
    {m:84, round:"R32", date:"2026-07-02", home:"Spain", away:"Austria", venue:"Los Angeles (SoFi Stadium)", time:"12:00", utc:"2026-07-02T19:00Z", hs:null, as:null, w:null},
    {m:85, round:"R32", date:"2026-07-02", home:"Switzerland", away:"Algeria", venue:"Vancouver (BC Place)", time:"20:00", utc:"2026-07-03T03:00Z", hs:null, as:null, w:null},
    {m:86, round:"R32", date:"2026-07-03", home:"Argentina", away:"Cape Verde", venue:"Miami (Hard Rock Stadium)", time:"18:00", utc:"2026-07-03T22:00Z", hs:null, as:null, w:null},
